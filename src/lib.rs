...
//! ```
//!
//! See the [example](https://github.com/antonok-edm/sh1108/blob/master/examples/demo.rs)
...
//! [the examples/ folder](https://github.com/antonok-edm/sh1108/blob/master/examples)
//!
